...
- 学习笔记带读者从例子和问题中逐步取得认识，教材把定义、实例、推导与理解难点展开。按[讲述口吻](references/sentence-construction.md#6-教材语气与作者引导)主动使用有作用的“我们”等共同主语与承接，保留自然的观察和推理过程。报告让结果、依据和影响采用的条件直接相接，参考记录以查询和复原为目的；文体由任务确定。

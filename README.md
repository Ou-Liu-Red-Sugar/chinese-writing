...
重点是让句子、分句和段落之间的关系在草图中就成立：如何从例子进入一般情形，怎样连续引入对象与记号，哪些地方详写，条件放在哪里，以及标点怎样组织尚未展开的内容。
...
| 第1版 | 段落与句群骨架 | 使用章节、详略和句子组成方法，写出起句、衔接、关联词、句界和标点；中间内容暂留明确占位 |
...
[句子组织校准材料](assets/sentence-calibration.md)保留创作者的局部改稿示范及采用分析，展示“现在，让我们……”“考虑……并设……记……则……”怎样在实际上下文中完成教学动作。

## Benchmarks

[公开题库](assets/benchmark-cases.json)有 **10道题、30道理解题**，涵盖融资引入、随后文改变句序、主语与修饰范围、标点辖域、详略、数学推导、报告精简、证据身份、必要限定和参考结构。
